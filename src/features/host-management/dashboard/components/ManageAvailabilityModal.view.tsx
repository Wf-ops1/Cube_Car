...
export const ManageAvailabilityModal: React.FC<ManageAvailabilityModalProps> = ({ carId, carModel, onClose }) => {
    ...
    // Mock initial data - in real app would fetch from backend
    ...
    for (let d = 1; d <= daysInMonth; d++) {
        ...
        if (status === 'RENTED') {
            ...
            // Available
            bgClass = 'hover:bg-emerald-50 text-slate-700 cursor-pointer';
        }
        ...
        days.push(
            <div key={d} className="flex justify-center">
                <button
                    ...
                    className={`w-10 h-10 rounded-full flex items-center justify-center text-sm transition-all duration-200 ${bgClass}`}
                    title={status}
                >
                    {d}
                </button>
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <motion.div
                ...
                className="relative bg-white rounded-[2rem] shadow-2xl w-full max-w-md overflow-hidden ring-1 ring-white/20"
            >
                {/* Header */}
                ...
                <div className="p-6">
                    ...
                    <div className="flex items-center justify-center gap-4 text-[10px] font-bold uppercase tracking-wider text-slate-500 border-t border-slate-100 pt-4">
                        <div className="flex items-center gap-1.5">
                            <div className="w-2 h-2 rounded-full bg-emerald-400"></div> Livre
                        </div>
                        <div className="flex items-center gap-1.5">
